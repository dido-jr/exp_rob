...
public:
  ...
  void init_knowledge()
  {
    ...
    problem_expert_->addPredicate(plansys2::Predicate("(is_lower wp1 lower)"));
      ...
      case PATROL_WP1:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(inspected wp2))"));
      ...
      case PATROL_WP2:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(inspected wp3))"));
      ...
      case PATROL_WP3:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(inspected wp4))"));
